...
@Component({
  ...
  imports: [MatButtonModule, MatSelectModule, CdkMenuModule, ReactiveFormsModule, 
    DragBehaviorDirective, NodeBehaviorDirective, SwitchComponent],
...
export class NetworkGraphComponent {
  ...
  constructor(private networkService: Networkv3Service, public dialog: MatDialog, private cdr: ChangeDetectorRef) {
